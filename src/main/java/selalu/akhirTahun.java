...
public class akhirTahun {
    public static void main(String[] args) {
        akhirTahun.testrunning();
    }
    ...
    static void testrunning(){
        try{
            ...
            while (rs.next()){
                ...
                //print the result
                System.out.format("Terima kasih karena Anda telah melakukan pembayaran pada invoice %s. Anda berhak mendapatkan diskon awal tahun sebesar 20%%!\n", invoiceid);
            }
            st.close();
